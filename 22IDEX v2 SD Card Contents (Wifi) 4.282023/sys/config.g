...
M550 P"VisionMiner 22IDEX"                               ; set printer name
...
M92 X80.4 Y80.4 U80.4 Z6400 E400:400               ; set steps per mm
...
M906 X1800 U1800 Y1800:1800 Z700 E600:600 I20      ; set motor currents (mA) and motor idle factor in per cent
...
M307 H0 R3.761 K0.505:0.153 D6.13 E1.35 S1.00 B0 V24.2 ; disable bang-bang mode for heater and set PID parameters
...
M307 H1 R3.761 K0.505:0.153 D6.13 E1.35 S1.00 B0 V24.2 ; disable bang-bang mode for heater and set PID parameters
...
M307 H2 R0.185 K0.035:0.000 D31.84 E1.35 S1.00 B0  ; Disable bang-bang mode for the bed heater and set PWM limit
